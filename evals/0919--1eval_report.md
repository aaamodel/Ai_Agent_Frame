...
- cost.avg_tokens_per_turn_max 违规：avg_tokens_per_turn=13149.0000 > 6000.0000
...
| 单轮 token 成本（端到端） | 13149 ❌ | 6000 | `cost.avg_tokens_per_turn_max` |
...
- `mean_latency_ms` = 11222.0350
- `median_tokens_per_turn` = 3611.0000
- `output_tokens` = 0
- `p95_latency_ms` = 13199.7085
- `total` = 2
- 样本数 = 2
- 真实 LLM 调用 2 次，input=6719 output=503 total=7222 tokens
...
- `hit@5` = 1.0000
- `mean_latency_ms` = 1703.8500
- `mrr` = 0.2000
- `p95_latency_ms` = 2645.7000
- `recall@5` = 1.0000
- `scored` = 1
...
- `avg_tokens_per_turn` = 13149.0000
- `error_rate` = 0.0000
- `key_arg_cases` = 2
- `key_arg_recall` = 0.5000
- `llm_calls_per_request` = 4.0000
- `mean_latency_ms` = 35696.6300
- `median_tokens_per_turn` = 13149.0000
- `memory_cleanup_failures` = 0
- `memory_isolated` = True
- `p95_latency_ms` = 38773.1180
- `tool_success_rate` = 1.0000
- `total` = 2
- 样本数 = 2
- 真实 LLM 调用 8 次，input=25475 output=823 total=26298 tokens
