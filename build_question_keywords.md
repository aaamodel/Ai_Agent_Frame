# 🔍 函数变量追踪报告: `build_question_keywords`
...
### 📍 游标到达行号: 152 (产生新变量或发生修改)
```json
{
  "node_key": "top_kb_node"
}
```

### 📍 游标到达行号: 153 (产生新变量或发生修改)
```json
{
  "node": null
}
...
### 📍 游标到达行号: 158 (产生新变量或发生修改)
```json
{
  "node_key": "top_system_node"
}
```

### 📍 游标到达行号: 166 (产生新变量或发生修改)
```json
{
  "fallback": "查退款政策"
}
